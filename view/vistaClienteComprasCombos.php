...
<div class="modal-dialog text-center">
    <div class="col-sm-12 main-section">
        <div class="modal-content">
            ...
            <form action="?controlador=Item&accion=comprar_Combo" method="POST" class="col-12" th:action="@{/login}" >




                <div class="form-group" id="nombre-group">
                    <input type="number" class="form-control" id="numeroTarjeta" name="numeroTarjeta" placeholder="Número Tarjeta: "  required="">
                </div>
                ...
                <div class="form-group" id="quantyly-group">
                    <input type="number" class="form-control" id="codigoPostalTarjeta" name="codigoPostalTarjeta" placeholder="Código Postal Tarjeta: " required="">
                </div>
             ...
             <input type="text" class="form-control" id="direccionPostalTarjeta" name="direccionPostalTarjeta" placeholder="Direccion Postal: "  required>
                </div>



                <div class="form-group" id="description-group">
                    <input type="text" class="form-control" id="descripcionPagoTarjeta" name="descripcionPagoTarjeta" placeholder="Descripcion: " required>
                </div>
